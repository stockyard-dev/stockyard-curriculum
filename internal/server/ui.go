...
const dashHTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Curriculum</title>
...
<div class="hdr"><h1><span>&#9670;</span> CURRICULUM</h1><button class="btn btn-p" id="add-btn">+ Add</button></div>
<div class="main"><div class="tabs" id="tabs"><div class="tab active" onclick="switchTab('courses')">Courses</div><div class="tab" onclick="switchTab('lessons')">Lessons</div></div><div class="tab-content active" id="tab-courses">
<div class="stats" id="stats-courses"></div>
<div class="toolbar">
<input class="search" id="search-courses" placeholder="Search..." oninput="renderRes('courses')"><select class="filter-sel" id="filter-courses-status" onchange="renderRes('courses')"><option value="">All Status</option><option value="Draft">Draft</option><option value="Active">Active</option><option value="Archived">Archived</option></select></div>
<div class="count-label" id="count-courses"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Course Title</th><th>Subject</th><th>Grade/Level</th><th>Description</th><th>Status</th><th></th></tr></thead><tbody id="tbody-courses"></tbody></table></div></div><div class="tab-content" id="tab-lessons">
<div class="stats" id="stats-lessons"></div>
<div class="toolbar">
<input class="search" id="search-lessons" placeholder="Search..." oninput="renderRes('lessons')"><select class="filter-sel" id="filter-lessons-status" onchange="renderRes('lessons')"><option value="">All Status</option><option value="Planned">Planned</option><option value="Taught">Taught</option><option value="Skipped">Skipped</option></select></div>
<div class="count-label" id="count-lessons"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Course ID</th><th>Lesson Title</th><th>Lesson #</th><th>Date</th><th>Duration (min)</th><th>Objectives</th><th>Materials</th><th>Content</th><th>Homework</th><th>Status</th><th></th></tr></thead><tbody id="tbody-lessons"></tbody></table></div></div></div><div class="modal-bg" id="mbg" onclick="if(event.target===this)closeModal()"><div class="modal" id="mdl"></div></div><script>var A="/api",data={},editId=null,activeRes="courses";var resCfg={"courses":{d:"Courses",f:[{n:"title",l:"Course Title",t:"text",r:true,o:[]},{n:"subject",l:"Subject",t:"text",r:false,o:[]},{n:"grade_level",l:"Grade/Level",t:"text",r:false,o:[]},{n:"description",l:"Description",t:"textarea",r:false,o:[]},{n:"status",l:"Status",t:"select",r:false,o:["Draft","Active","Archived"]}]},"lessons":{d:"Lessons",f:[{n:"course_id",l:"Course ID",t:"text",r:true,o:[]},{n:"title",l:"Lesson Title",t:"text",r:true,o:[]},{n:"lesson_number",l:"Lesson #",t:"integer",r:false,o:[]},{n:"date",l:"Date",t:"date",r:false,o:[]},{n:"duration_minutes",l:"Duration (min)",t:"integer",r:false,o:[]},{n:"objectives",l:"Objectives",t:"textarea",r:false,o:[]},{n:"materials",l:"Materials",t:"textarea",r:false,o:[]},{n:"content",l:"Content",t:"textarea",r:false,o:[]},{n:"homework",l:"Homework",t:"textarea",r:false,o:[]},{n:"status",l:"Status",t:"select",r:false,o:["Planned","Taught","Skipped"]}]},};
